...
public class ViewVendorAcceptedEvents_View {
	...
	public ViewVendorAcceptedEvents_View() {
		...
		acceptedInvs = VendorController.getAllAcceptedEvents(SessionManager.getLoggedInUser().getUser_email());
	    ...
	    viewEventDetailsBtn.setOnAction(Event->{
	    	ViewVendorAcceptedEventDetails_View viewVendorAcceptedEventDetails = new ViewVendorAcceptedEventDetails_View();
	    	Main.redirect(viewVendorAcceptedEventDetails.getViewAcceptedEventDetailsScene());
	    });
